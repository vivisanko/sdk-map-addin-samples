...
geotab.addin.request = (elt, service) => {
    elt.innerHTML = `
        ...
        let type: HTMLInputElement = elt.querySelector("#addin_type");
        let coords: HTMLInputElement = elt.querySelector("#addin_coords");
        let fill: HTMLInputElement = elt.querySelector("#addin_fill");
        let stroke: HTMLInputElement = elt.querySelector("#addin_stroke");
